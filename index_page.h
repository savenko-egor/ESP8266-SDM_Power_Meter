  ...
  <BODY onload='process()'>
    <CENTER>
      ...
      <TABLE BORDER=1>
        ...
        <TR><TH title="ACTIVE APPARENT POWER">ACTIVE APPARENT POWER</TH><TD><A id='resp5'></A></TD><TD>VA</TD></TR>
        <TR><TH title="REACTIVE APPARENT POWER">REACTIVE APPARENT POWER</TH><TD><A id='resp6'></A></TD><TD>VAR</TD></TR>
        <TR><TH title="IMPORT ACTIVE ENERGY">IMPORT ACTIVE ENERGY</TH><TD><A id='resp7'></A></TD><TD>Wh</TD></TR>
        <TR><TH title="EXPORT ACTIVE ENERGY">EXPORT ACTIVE ENERGY</TH><TD><A id='resp8'></A></TD><TD>Wh</TD></TR>
        <TR><TH title="TOTAL ACTIVE ENERGY">TOTAL ACTIVE ENERGY</TH><TD><A id='resp9'></A></TD><TD>Wh</TD></TR>
